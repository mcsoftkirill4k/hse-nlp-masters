...
Семинары и домашки по NLP. Складываю сюда прорешанное по курсу.
...
| [`week_02_word_embeddings_hw/`](week_02_word_embeddings_hw/) | домашка: FastText, Quora finetune, FAISS |
| [`week_02_salary_ru/`](week_02_salary_ru/) | семинар week 2: зарплаты hh.ru + Navec + TextCNN |
